 ...
 * @param bounds                 The bounds of the view to draw to the context.
 * @param afterScreenUpdates     Boolean indicating whether to render before (@c NO) or after (@c
 *                               YES) screen updates.
 */
+ (void)drawViewInContext:(CGContextRef)bitmapContextRef
  ...
  if ([view isKindOfClass:gUIAlertControllerShimPresenterWindowClass] ||
    ...
    CGRect localFrame = [view convertRect:bounds fromView:nil];
