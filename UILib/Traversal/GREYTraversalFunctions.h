 ...
 *  @param parentElement    UI element whose properties are being passed down. This can be either
 *                          a UIView or an accessibility element.
 *  @param childElement     UI element to pass down the properties to. This can be either a UIView
 *                          or an accessibility element. Properties are passed down directly if @c
 *                          childElement is @c nil.
 *
