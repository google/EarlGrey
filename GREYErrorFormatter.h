...
/**
 * For a given @c hierarchy, creates the human-readable hierarchy
...
/**
 * For a given @c error, creates a GREYErrorFormatter to provide a formattedDescription.
 *
...
/**
 * Creates the human-readable formatted string for the GREYError,
