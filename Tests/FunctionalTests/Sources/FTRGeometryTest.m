...
- (void)testCGRectFixedToVariableScreenCoordinates_landscapeRight {
  ...
  CGRect rectInFixed = CGRectMake(0, (iOS8_OR_ABOVE() ? width : height) - 20,
                                  10, 20);
  ...
  rectInFixed = CGRectMake((iOS8_OR_ABOVE() ? height : width) - 10,
                           (iOS8_OR_ABOVE() ? width : height) - 20,
                           10, 20);
  actualRect = CGRectFixedToVariableScreenCoordinates(rectInFixed);
  expectedRect = CGRectMake(0, (iOS8_OR_ABOVE() ? height : width) - 10, 20, 10);
  XCTAssertTrue(CGRectEqualToRect(expectedRect, actualRect));

  // Too left => Top right
  rectInFixed = CGRectMake(0, 0, 10, 20);
  actualRect = CGRectFixedToVariableScreenCoordinates(rectInFixed);
  expectedRect = CGRectMake((iOS8_OR_ABOVE() ? width : height) - 20, 0,
                            20, 10);
  XCTAssertTrue(CGRectEqualToRect(expectedRect, actualRect));

  // Too right => bottom right
  rectInFixed = CGRectMake((iOS8_OR_ABOVE() ? height : width) - 10, 0,
                           10, 20);
  actualRect = CGRectFixedToVariableScreenCoordinates(rectInFixed);
  expectedRect = CGRectMake((iOS8_OR_ABOVE() ? width : height) - 20,
                            (iOS8_OR_ABOVE() ? height : width) - 10,
                            20, 10);
  XCTAssertTrue(CGRectEqualToRect(expectedRect, actualRect));
}
...
- (void)testCGRectFixedToVariableScreenCoordinates_landscapeLeft {
  ...
  CGRect rectInFixed = CGRectMake((iOS8_OR_ABOVE() ? height : width) - 120, 50, 120, 100);
  CGRect actualRect = CGRectFixedToVariableScreenCoordinates(rectInFixed);
  XCTAssertTrue(CGRectEqualToRect(CGRectMake(50, 0, 100, 120), actualRect));

  rectInFixed = CGRectMake(0, (iOS8_OR_ABOVE() ? width : height), 0, 0);
  actualRect = CGRectFixedToVariableScreenCoordinates(rectInFixed);
  XCTAssertTrue(CGRectEqualToRect(CGRectMake((iOS8_OR_ABOVE() ? width : height),
                                             (iOS8_OR_ABOVE() ? height : width), 0, 0),
                                  actualRect));
}
...
- (void)testCGRectVariableToFixedScreenCoordinates_landscapeRight {
  ...
  XCTAssertTrue(CGRectEqualToRect(CGRectMake(0, (iOS8_OR_ABOVE() ? width : height), 0, 0),
                                  actualRect));
}
...
- (void)testCGRectVariableToFixedScreenCoordinates_landscapeLeft {
  ...
  CGRect actualRect = CGRectVariableToFixedScreenCoordinates(rectInVariable);
  XCTAssertTrue(CGRectEqualToRect(CGRectMake((iOS8_OR_ABOVE() ? height : width) - 120,
                                             50,
                                             120,
                                             100),
                                  actualRect));

  rectInVariable = CGRectMake((iOS8_OR_ABOVE() ? width : height),
                              (iOS8_OR_ABOVE() ? height : width), 0, 0);
