 ...
 *  counted.
 */
@interface FTRAnalyticsTestPostTearDownTestDelegate : NSObject <GREYAnalyticsDelegate>
@end

@implementation FTRAnalyticsTestPostTearDownTestDelegate
 ...
 */
@interface FTRAnalyticsTestPostTearDownTest : XCTestCase
@end

@implementation FTRAnalyticsTestPostTearDownTest
...
- (void)setUp {
  ...
  gTestAnalyticsDelegate = [[FTRAnalyticsTestPostTearDownTestDelegate alloc] init];
