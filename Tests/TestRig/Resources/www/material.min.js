!function() {
  ...
  function e(e, t) {
    if (e) {
      if (t.element_.classList.contains(t.CssClasses_.MDL_JS_RIPPLE_EFFECT)) {
        ...
        i.classList.add(t.CssClasses_.MDL_RIPPLE), s.appendChild(i),
            e.appendChild(s)
      }
      e.addEventListener('click', function(s) {
        s.preventDefault();
        var i = e.href.split('#')[1], n = t.element_.querySelector('#' + i);
        t.resetTabState_(), t.resetPanelState_(),
  ...
  function t(e, t, s, i) {
    function n() {
      ...
      i.resetTabState_(t), i.resetPanelState_(s),
  ...
  s =
    ...
    function i(t, s) {
      if ('undefined' == typeof t && 'undefined' == typeof s)
        ...
        for (var r = document.querySelectorAll('.' + s), _ = 0; _ < r.length;
             _++)
          n(r[_], l)
      }
    }
    function n(i, n) {
      ...
      if (n)
        ...
        h.forEach(function(e) {
          o.contains(e.cssClass) && -1 === l.indexOf(e) && !s(i, e.className) &&
              l.push(e)
        })
      }
      for (var r, _ = 0, d = l.length; d > _; _++) {
        ...
        'CustomEvent' in window && 'function' == typeof window.CustomEvent ?
            m = new Event(
                'mdl-componentupgraded', {bubbles: !0, cancelable: !1}) :
    ...
    function a(e) {
      Array.isArray(e) ||
          (e = 'function' == typeof e.item ? Array.prototype.slice.call(e) :
                                             [e]);
    ...
    function l(t) {
      ...
      if (h.forEach(function(e) {
        ...
        throw new Error(
            'MDL component classes must not have ' + p +
    ...
    function _(e) {
      if (e) {
        ...
        'CustomEvent' in window&& 'function' == typeof window.CustomEvent ?
            n = new Event(
                'mdl-componentdowngraded', {bubbles: !0, cancelable: !1}) :
    ...
    return {
      upgradeDom: i, upgradeElement: n, upgradeElements: a,
          upgradeAllRegistered: r, registerUpgradedCallback: o, register: l,
          downgradeElements: d
    }
  }(),
  s.ComponentConfigPublic, s.ComponentConfig, s.Component,
  s.upgradeDom = s.upgradeDom, s.upgradeElement = s.upgradeElement,
  ...
  s.register = s.register, s.downgradeElements = s.downgradeElements,
  window.componentHandler = s, window.componentHandler = s,
  ...
  for (var i = ['webkit', 'moz'], n = 0;
       n < i.length && !window.requestAnimationFrame; ++n) {
    var a = i[n];
    window.requestAnimationFrame = window[a + 'RequestAnimationFrame'],
    window.cancelAnimationFrame = window[a + 'CancelAnimationFrame'] ||
  ...
  window.MaterialCheckbox = r, r.prototype.Constant_ = {TINY_TIMEOUT: .001},
  ...
  r.prototype.onChange_ =
      function(e) {
    this.updateClasses_()
  },
  r.prototype.onFocus_ =
      function(e) {
  ...
  r.prototype.onMouseUp_ =
      function(e) {
    this.blur_()
  },
  r.prototype.updateClasses_ =
      function() {
  ...
  r.prototype.disable = r.prototype.disable, r.prototype.enable = function() {
    ...
    if (this.element_) {
      ...
      var s = document.createElement('span');
      if (s.classList.add(this.CssClasses_.TICK_OUTLINE), e.appendChild(s),
          this.element_.appendChild(t), this.element_.appendChild(e),
  ...
  window.MaterialIconToggle = _, _.prototype.Constant_ = {TINY_TIMEOUT: .001},
  ...
  _.prototype.onChange_ =
      function(e) {
    this.updateClasses_()
  },
  _.prototype.onFocus_ =
      function(e) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
  },
  _.prototype.onBlur_ =
  ...
  _.prototype.onMouseUp_ =
      function(e) {
    this.blur_()
  },
  _.prototype.updateClasses_ =
      function() {
    this.checkDisabled(), this.checkToggleState()
  },
  _.prototype.blur_ =
  ...
  d.prototype.init = function() {
    if (this.element_) {
      ...
      e.classList.add(this.CssClasses_.CONTAINER),
          ...
          e.appendChild(this.element_), this.container_ = e;
      ...
      if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT))
        for (this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS),
          ...
          r.classList.add(this.CssClasses_.RIPPLE), o.appendChild(r),
              l.appendChild(o), l.classList.add(this.CssClasses_.RIPPLE_EFFECT)
        }
    ...
    if (this.element_ && this.container_) {
      ...
      if (t && t.length > 0 &&
        ...
        if (e.keyCode === this.Keycodes_.UP_ARROW)
          ...
          e.target.dispatchEvent(i), i = new MouseEvent('mouseup'),
                                     e.target.dispatchEvent(i), e.target.click()
        } else
    ...
    e.target.hasAttribute('disabled') ?
        e.stopPropagation() :
        (this.closing_ = !0, window.setTimeout(function(e) {
    ...
    this.element_.classList.contains(this.CssClasses_.UNALIGNED) ?
        ...
        this.element_.classList.contains(this.CssClasses_.TOP_RIGHT) ?
        this.element_.style.clip = 'rect(' + e + 'px ' + t + 'px ' + e + 'px ' +
                        t + 'px)' :
        this.element_.style.clip = ''
    ...
    if (this.element_ && this.container_ && this.outline_) {
      ...
      for (var i = this.Constant_.TRANSITION_DURATION_SECONDS *
      ...
      var o = function(t) {
        t === e || this.closing_ || t.target.parentNode === this.element_ ||
  ...
  h.prototype.setBuffer = h.prototype.setBuffer, h.prototype.init = function() {
    if (this.element_) {
      var e = document.createElement('div');
      e.className = 'progressbar bar bar1', this.element_.appendChild(e),
      this.progressbar_ = e, e = document.createElement('div'),
      e.className = 'bufferbar bar bar2', this.element_.appendChild(e),
      this.bufferbar_ = e, e = document.createElement('div'),
      e.className = 'auxbar bar bar3', this.element_.appendChild(e),
      this.auxbar_ = e, this.progressbar_.style.width = '0%',
      this.bufferbar_.style.width = '100%', this.auxbar_.style.width = '0%',
  ...
  window.MaterialRadio = c, c.prototype.Constant_ = {TINY_TIMEOUT: .001},
  ...
  c.prototype.onChange_ =
      function(e) {
    for (var t = document.getElementsByClassName(this.CssClasses_.JS_RADIO),
             s = 0;
         s < t.length; s++) {
  ...
  c.prototype.onMouseup_ =
      function(e) {
    this.blur_()
  },
  c.prototype.updateClasses_ =
      function() {
    this.checkDisabled(), this.checkToggleState()
  },
  c.prototype.blur_ =
  ...
  c.prototype.disable = c.prototype.disable, c.prototype.enable = function() {
    ...
    if (this.element_) {
      this.btnElement_ =
          this.element_.querySelector('.' + this.CssClasses_.RADIO_BTN),
      ...
      t.classList.add(this.CssClasses_.RADIO_INNER_CIRCLE),
          this.element_.appendChild(e), this.element_.appendChild(t);
      var s;
      if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
        this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS),
        ...
        var i = document.createElement('span');
        i.classList.add(this.CssClasses_.RIPPLE), s.appendChild(i),
  ...
  var p = function(e) {
    this.element_ = e, this.isIE_ = window.navigator.msPointerEnabled,
    this.init()
  };
  ...
  p.prototype.onInput_ =
      function(e) {
    this.updateValueStyles_()
  },
  p.prototype.onChange_ =
      function(e) {
    this.updateValueStyles_()
  },
  p.prototype.onMouseUp_ =
      function(e) {
    e.target.blur()
  },
  p.prototype.onContainerMouseDown_ =
      function(e) {
  ...
  p.prototype.updateValueStyles_ =
      function() {
    var e = (this.element_.value - this.element_.min) /
        (this.element_.max - this.element_.min);
    0 === e ? this.element_.classList.add(this.CssClasses_.IS_LOWEST_VALUE) :
  ...
  p.prototype.disable = p.prototype.disable, p.prototype.enable = function() {
    ...
    if (this.element_) {
      if (this.isIE_) {
        ...
        s.classList.add(this.CssClasses_.BACKGROUND_FLEX), t.appendChild(s),
  ...
  var C = function(e) {
    ...
    this.active = !1, this.actionHandler_ = void 0, this.message_ = void 0,
    this.actionText_ = void 0, this.queuedNotifications_ = [],
    this.setActionHidden_(!0)
  };
  window.MaterialSnackbar = C, C.prototype.Constant_ = {ANIMATION_LENGTH: 250},
  C.prototype.cssClasses_ = {
  ...
  C.prototype.showSnackbar =
    ...
    this.active ? this.queuedNotifications_.push(e) :
                  (this.active = !0, this.message_ = e.message,
    ...
    this.element_.classList.remove(this.cssClasses_.ACTIVE),
        setTimeout(function() {
          this.element_.setAttribute('aria-hidden', 'true'),
              ...
              (this.setActionHidden_(!0), this.actionElement_.textContent = '',
               this.actionElement_.removeEventListener(
                   'click', this.actionHandler_)),
              this.actionHandler_ = void 0, this.message_ = void 0,
              this.actionText_ = void 0, this.active = !1, this.checkQueue_()
        }.bind(this), this.Constant_.ANIMATION_LENGTH)
  }, C.prototype.setActionHidden_ = function(e) {
    e ? this.actionElement_.setAttribute('aria-hidden', 'true') :
  ...
  u.prototype.createLayer =
    ...
    t.appendChild(s), t.appendChild(i), t.appendChild(n),
  ...
  window.MaterialSwitch = E, E.prototype.Constant_ = {TINY_TIMEOUT: .001},
  ...
  E.prototype.onChange_ =
      function(e) {
    this.updateClasses_()
  },
  E.prototype.onFocus_ =
      function(e) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
  },
  E.prototype.onBlur_ =
  ...
  E.prototype.onMouseUp_ =
      function(e) {
    this.blur_()
  },
  E.prototype.updateClasses_ =
      function() {
    this.checkDisabled(), this.checkToggleState()
  },
  E.prototype.blur_ =
  ...
  E.prototype.disable = E.prototype.disable, E.prototype.enable = function() {
    ...
    if (this.element_) {
      ...
      var s = document.createElement('span');
      if (s.classList.add(this.CssClasses_.FOCUS_HELPER), t.appendChild(s),
          this.element_.appendChild(e), this.element_.appendChild(t),
          this.boundMouseUpHandler = this.onMouseUp_.bind(this),
          this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
        this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS),
            ...
            this.rippleContainerElement_.classList.add(
                this.CssClasses_.RIPPLE_CENTER),
            this.rippleContainerElement_.addEventListener(
                'mouseup', this.boundMouseUpHandler);
        var i = document.createElement('span');
        i.classList.add(this.CssClasses_.RIPPLE),
            this.rippleContainerElement_.appendChild(i),
            this.element_.appendChild(this.rippleContainerElement_)
  ...
  L.prototype.onKeyDown_ =
      function(e) {
    var t = e.target.value.split('\n').length;
    13 === e.keyCode && t >= this.maxRows && e.preventDefault()
  },
  L.prototype.onFocus_ =
      function(e) {
    this.element_.classList.add(this.CssClasses_.IS_FOCUSED)
  },
  L.prototype.onBlur_ =
  ...
  L.prototype.onReset_ =
      function(e) {
    this.updateClasses_()
  },
  L.prototype.updateClasses_ =
      function() {
    this.checkDisabled(), this.checkValidity(), this.checkDirty(),
        this.checkFocus()
  },
  L.prototype.checkDisabled =
      function() {
    ...
    if (this.element_ &&
      ...
      this.input_.hasAttribute(this.Constant_.MAX_ROWS_ATTRIBUTE) &&
          (this.maxRows = parseInt(
               this.input_.getAttribute(this.Constant_.MAX_ROWS_ATTRIBUTE), 10),
  ...
  I.prototype.handleMouseEnter_ = function(e) {
    var t = e.target.getBoundingClientRect(), s = t.left + t.width / 2,
        i = t.top + t.height / 2, n = -1 * (this.element_.offsetWidth / 2),
      ...
      e && (this.forElement_ = document.getElementById(e)),
          ...
          (this.forElement_.hasAttribute('tabindex') ||
           ...
           this.forElement_.addEventListener(
               'mouseenter', this.boundMouseEnterHandler, !1),
           this.forElement_.addEventListener(
               'touchend', this.boundMouseEnterHandler, !1),
           this.forElement_.addEventListener(
               'mouseleave', this.boundMouseLeaveHandler, !1),
  ...
  f.prototype.contentScrollHandler_ =
      function() {
  ...
  f.prototype.keyboardEventHandler_ =
      function(e) {
    e.keyCode === this.Keycodes_.ESCAPE &&
        this.drawer_.classList.contains(this.CssClasses_.IS_DRAWER_OPEN) &&
        this.toggleDrawer()
  },
  f.prototype.screenSizeHandler_ =
      function() {
  ...
  f.prototype.drawerToggleHandler_ =
      function(e) {
    if (e && 'keydown' === e.type) {
      if (e.keyCode !== this.Keycodes_.SPACE &&
          e.keyCode !== this.Keycodes_.ENTER)
        return;
      e.preventDefault()
    }
  ...
  f.prototype.headerTransitionEndHandler_ =
      function() {
    this.header_.classList.remove(this.CssClasses_.IS_ANIMATING)
  },
  f.prototype.headerClickHandler_ =
      function() {
    this.header_.classList.contains(this.CssClasses_.IS_COMPACT) &&
        (this.header_.classList.remove(this.CssClasses_.IS_COMPACT),
         this.header_.classList.add(this.CssClasses_.IS_ANIMATING))
  },
  f.prototype.resetTabState_ =
      function(e) {
    for (var t = 0; t < e.length; t++)
      e[t].classList.remove(this.CssClasses_.IS_ACTIVE)
  },
  f.prototype.resetPanelState_ =
      function(e) {
    for (var t = 0; t < e.length; t++)
      e[t].classList.remove(this.CssClasses_.IS_ACTIVE)
  },
  ...
  f.prototype.init = function() {
    if (this.element_) {
      ...
      this.element_.parentElement.insertBefore(e, this.element_),
          this.element_.parentElement.removeChild(this.element_),
          e.appendChild(this.element_), s && s.focus();
      for (var i = this.element_.childNodes, n = i.length, a = 0; n > a; a++) {
        var l = i[a];
        l.classList && l.classList.contains(this.CssClasses_.HEADER) &&
            (this.header_ = l),
            l.classList && l.classList.contains(this.CssClasses_.DRAWER) &&
            (this.drawer_ = l),
            l.classList && l.classList.contains(this.CssClasses_.CONTENT) &&
            (this.content_ = l)
      }
      ...
      if (this.header_ &&
              (this.header_.classList.contains(this.CssClasses_.HEADER_SEAMED) ?
                   ...
                   (o = this.Mode_.WATERFALL,
                    ...
                    this.header_.addEventListener(
                        'click', this.headerClickHandler_.bind(this))) :
                   this.header_.classList.contains(
        ...
        if (!r) {
          ...
          _.classList.add(this.CssClasses_.ICON),
              _.innerHTML = this.Constant_.MENU_ICON, r.appendChild(_)
        }
        ...
        d.classList.add(this.CssClasses_.OBFUSCATOR),
            ...
            this.drawer_.addEventListener(
                'keydown', this.keyboardEventHandler_.bind(this)),
            this.drawer_.setAttribute('aria-hidden', 'true')
      }
      if (this.screenSizeMediaQuery_ =
          ...
          this.screenSizeHandler_(), this.header_ && this.tabBar_) {
        ...
        p.classList.add(this.CssClasses_.ICON),
            p.textContent = this.Constant_.CHEVRON_LEFT, c.appendChild(p),
        ...
        u.classList.add(this.CssClasses_.ICON),
            u.textContent = this.Constant_.CHEVRON_RIGHT, C.appendChild(u),
            C.addEventListener(
                'click',
                function() {
                  this.tabBar_.scrollLeft += this.Constant_.TAB_SCROLL_PIXELS
                }.bind(this)),
            h.appendChild(c), h.appendChild(this.tabBar_), h.appendChild(C);
        var E = function() {
  ...
  b.prototype.selectRow_ = function(e, t, s) {
    return t ? function() {
      e.checked ? t.classList.add(this.CssClasses_.IS_SELECTED) :
    ...
    return a.type = 'checkbox', a.classList.add('mdl-checkbox__input'),
           ...
           i.appendChild(a), s.upgradeElement(i, 'MaterialCheckbox'), i
  ...
  y.prototype.downHandler_ = function(e) {
    if (!this.rippleElement_.style.width && !this.rippleElement_.style.height) {
      ...
      this.boundHeight = t.height, this.boundWidth = t.width,
      this.rippleSize_ =
    ...
    if (this.rippleElement_.classList.add(this.CssClasses_.IS_VISIBLE),
      ...
      this.setRippleXY(i, n), this.setRippleStyles(!0),
    ...
    if (this.element_) {
      ...
      this.element_.classList.contains(
          ...
          (this.rippleElement_ =
           ...
           this.frameCount_ = 0, this.rippleSize_ = 0, this.x_ = 0, this.y_ = 0,
           this.ignoringMouseDown_ = !1,
                 ...
                 if (null !== this.rippleElement_) {
                   ...
                   t ? (i = this.Constant_.INITIAL_SCALE,
                       ...
                       (i = this.Constant_.FINAL_SCALE,
                        ...
                        e &&
                            (a = 'translate(' + this.boundWidth / 2 + 'px, ' +
                       ...
                       t ? this.rippleElement_.classList.remove(
