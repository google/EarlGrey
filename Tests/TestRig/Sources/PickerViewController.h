...
@property(nonatomic) id<UIPickerViewDelegate> pickerViewDelegate1;
@property(nonatomic) id<UIPickerViewDelegate> pickerViewDelegate2;
@property(nonatomic) id<UIPickerViewDelegate> pickerViewDelegate3;
@property(nonatomic) id<UIPickerViewDelegate> pickerViewDelegate4;
