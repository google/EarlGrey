...
+ (id)rangeWithStartPosition:(CustomTextPosition *)startPosition
  ...
  [range setStartPosition:startPosition];
  [range setEndPosition:endPosition];
  return range;
}
...
- (void)setStartPosition:(CustomTextPosition *)position {
  _start = position;
}
...
- (void)setEndPosition:(CustomTextPosition *)position {
  _end = position;
}
...
- (id)copyWithZone:(NSZone *)zone {
  ...
  [copiedRange setEndPosition:(CustomTextPosition *)[self end]];
  [copiedRange setStartPosition:(CustomTextPosition *)[self start]];
  return copiedRange;
}
...
- (void)drawRect:(CGRect)rect {
  ...
  [_textStore drawInRect:rectForText
...
- (void)deleteBackward {
  ...
  CustomTextRange *newRange =
      [CustomTextRange rangeWithStartPosition:position endPosition:position];
...
- (void)replaceRange:(UITextRange *)range withText:(NSString *)text {
  ...
  CustomTextPosition *position = [[CustomTextPosition alloc] initWithPosition:start + text.length];
...
- (UITextPosition *)positionFromPosition:(UITextPosition *)position
  ...
  UITextRange *newRange =
      [CustomTextRange rangeWithStartPosition:newPosition endPosition:newPosition];
  [self setSelectedTextRange:newRange];
