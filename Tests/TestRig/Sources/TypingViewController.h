...
@class CustomKeyboardTracker;

// View controller for the Typing section of the TestApp.
@interface TypingViewController : UIViewController <UITextFieldDelegate, UITextViewDelegate>
...
@property(nonatomic, retain) IBOutlet CustomKeyboardTracker *customKeyboardTracker;
