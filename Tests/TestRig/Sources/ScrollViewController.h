...
// Class that controls ScrollViewController.xib view. The view contains various scroll views used
...
@property(unsafe_unretained, nonatomic) IBOutlet UIScrollView *smallContentScrollView;
