...
@interface AnalyticsTestMethodOptOutTest : BaseAnalyticsTest
@end

@implementation AnalyticsTestMethodOptOutTest

- (void)testMethodThatOptsOutOfAnalytics {
  [BaseAnalyticsTest setExpectedAnalyticsRequestsCount:1];
  ...
  [BaseAnalyticsTest setExpectedAnalyticsRequestsCount:0];
}
