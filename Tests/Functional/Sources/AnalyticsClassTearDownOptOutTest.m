 ...
 */
@interface AnalyticsClassTearDownOptOutTestDelegate : NSObject <GREYAnalyticsDelegate>
@end

@implementation AnalyticsClassTearDownOptOutTestDelegate
 ...
 */
@interface AnalyticsClassTearDownOptOutTest : XCTestCase
@end

@implementation AnalyticsClassTearDownOptOutTest
...
- (void)setUp {
  ...
  id<GREYAnalyticsDelegate> testDelegate = [[AnalyticsClassTearDownOptOutTestDelegate alloc] init];
