...
@interface UIViewController_GREYAdditionsTest : GREYAppBaseTest
@end
...
- (void)testViewTransitionChangesPendingUIEventState {
  ...
  XCTAssertEqual(kGREYPendingViewsToAppear, [[GREYAppStateTracker sharedInstance] currentState],
                 @"Should change state.");

  [viewController viewDidAppear:NO];
  XCTAssertEqual(kGREYIdle, [[GREYAppStateTracker sharedInstance] currentState], @"Should idle.");

  [viewController viewWillDisappear:NO];
  XCTAssertEqual(kGREYPendingViewsToDisappear, [[GREYAppStateTracker sharedInstance] currentState],
                 @"Should change state.");
...
- (void)testRootViewControllerAppearance {
  ...
  XCTAssertTrue(
      [[GREYAppStateTracker sharedInstance] currentState] & kGREYPendingRootViewControllerToAppear,
...
- (void)testViewWillAppearInteractiveTransitionCancelled {
  ...
  id transitionCoordinator =
      [OCMockObject mockForProtocol:@protocol(UIViewControllerTransitionCoordinator)];
  ...
  id context =
      [OCMockObject mockForProtocol:@protocol(UIViewControllerTransitionCoordinatorContext)];
