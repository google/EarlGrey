...
@interface CAAnimation_GREYAdditionsTest : GREYAppBaseTest <CAAnimationDelegate>
#else
@interface CAAnimation_GREYAdditionsTest : GREYAppBaseTest
#endif
@end
...
- (void)testAnimationWithDelegate {
  ...
  [[animation delegate] animationDidStart:animation];
  XCTAssertTrue(_animationDidStartCalled, @"Original delegate not called.");
  [[animation delegate] animationDidStop:animation finished:YES];
  XCTAssertTrue(_animationDidStopCalled, @"Original delegate not called.");
}
...
- (void)testAnimationImplementationWithDelegateWithoutMethodsImplemented {
  ...
  XCTAssertEqual([delegate methodForSelector:@selector(animationDidStop:finished:)], didStopMethod);
}
