...
@interface GREYUIThreadExecutor (UIView_GREYAdditionsTest)
...
- (void)testKeepSubviewOnTopWithAddSubview {
  ...
  XCTAssertEqual(subviewToKeepOnTop, [view.subviews lastObject],
  ...
  XCTAssertEqual(nonTopSubview2, [view.subviews lastObject],
...
- (void)testMultipleKeepSubviewOnTopWithAddSubview {
  ...
  XCTAssertEqual(subviewToKeepOnTop1, [view.subviews lastObject],
                 @"added subview should be on top");
  [view addSubview:subviewToKeepOnTop2];
  XCTAssertEqual(subviewToKeepOnTop2, [view.subviews lastObject],
                 @"added subview should be on top");
