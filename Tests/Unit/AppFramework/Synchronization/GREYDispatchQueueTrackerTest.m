...
@interface GREYDispatchQueueTrackerTest : GREYAppBaseTest
@end
...
- (void)testIsInitiallyIdle {
  [GREYConfiguration.sharedConfiguration setValue:@(1.0)
...
- (void)testTrackerDoesNotTrackDispatchAfterBlock {
  [GREYConfiguration.sharedConfiguration setValue:@(0.05)
                                     forConfigKey:kGREYConfigKeyDispatchAfterMaxTrackableDelay];
  GREYDispatchQueueTracker *tracker =
      [GREYDispatchQueueTracker trackerForDispatchQueue:_serialQueue];
  __block BOOL executed = NO;
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.1 * NSEC_PER_SEC)), _serialQueue, ^{
    executed = YES;
  });
...
- (void)testTrackerTracksDispatchAfterBlock {
  [GREYConfiguration.sharedConfiguration setValue:@(0.1)
                                     forConfigKey:kGREYConfigKeyDispatchAfterMaxTrackableDelay];
  GREYDispatchQueueTracker *tracker =
      [GREYDispatchQueueTracker trackerForDispatchQueue:_serialQueue];
  ...
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.05 * NSEC_PER_SEC)), _serialQueue, ^{
    dispatch_time_t timeout = dispatch_time(DISPATCH_TIME_NOW, (int64_t)(5.0 * NSEC_PER_SEC));
    dispatch_semaphore_wait(semaphore, timeout);
    [expectation fulfill];
  });
...
- (void)testTrackerTracksDispatchAsyncBlock {
  ...
  [GREYConfiguration.sharedConfiguration setValue:@(trackableValue)
                                     forConfigKey:kGREYConfigKeyDispatchAfterMaxTrackableDelay];
  GREYDispatchQueueTracker *tracker =
      [GREYDispatchQueueTracker trackerForDispatchQueue:_serialQueue];
...
- (void)testTrackerTracksDispatchAfterFunction {
  ...
  dispatch_after_f(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.05 * NSEC_PER_SEC)), _serialQueue,
                   (__bridge void *)container, testFunction);
...
- (void)testIsTrackingALiveQueueWithALivingQueue {
  ...
  ;
  GREYDispatchQueueTracker *tracker = [GREYDispatchQueueTracker trackerForDispatchQueue:queue];
