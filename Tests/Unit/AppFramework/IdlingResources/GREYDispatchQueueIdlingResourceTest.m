...
@interface GREYDispatchQueueIdlingResourceTest : GREYAppBaseTest
@end
...
- (void)testQueueName {
  ...
  GREYDispatchQueueIdlingResource *idlingRes =
      [GREYDispatchQueueIdlingResource resourceWithDispatchQueue:queue name:queueName];
...
- (void)testIdlingResourceWeaklyHoldsQueueAndDeregistersItselfAfterOperationsHaveCompleted {
  ...
  @autoreleasepool {
    ...
    dispatchQueueIdlingResource =
        [GREYDispatchQueueIdlingResource resourceWithDispatchQueue:queue name:@"test"];
  ...
  // TODO: Can't import GREYCondition since it is part of TestLib. // NOLINT
