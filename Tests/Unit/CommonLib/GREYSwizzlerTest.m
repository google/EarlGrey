...
@interface GREYSwizzlerTest : XCTestCase
@end
...
- (void)testResetInstanceMethods {
  ...
  XCTAssertTrue(
      [_swizzler resetInstanceMethod:@selector(instanceMethod2) class:[GREYUTClassA class]],
      @"Reset should succeed");
  XCTAssertEqualObjects([_objectA instanceMethod2], @"Class A Instance Method 2");
}
...
- (void)testSwizzleGREYUTClassAfterAddingMethod {
  ...
  XCTAssertEqualObjects([_objectA instanceMethod1], @"Class A Added Instance Method called",
...
- (void)testSwizzlingWithReplaceMethod_IncorrectClassMethods {
  ...
  XCTAssertFalse(swizzleSucceeded, @"Swizzle should Fail because the methods used are incorrect.");
...
- (void)testSwizzleSameMethodTwiceAndReset {
  ...
  XCTAssertTrue(
      [_swizzler resetInstanceMethod:@selector(instanceMethod3) class:[GREYUTClassA class]]);
  XCTAssertEqualObjects([_objectA instanceMethod3], @"Class A Instance Method 3");
  XCTAssertEqualObjects([_objectA instanceMethod1], @"Class A Instance Method 3");
}
