...
#import "Tests/Unit/UILib/GREYUTAccessibilityViewContainerView.h"
#import "Tests/Unit/UILib/GREYUTCustomAccessibilityView.h"
...
+ (NSString *)grey_hierarchyStringForElement:(id)element
...
- (void)testHierarchyStringWithValidHierarchy {
  ...
  NSArray *stringTargetHierarchy =
      @[ @"<GREYUTCustomAccessibilityView:", @"  |--<UIView:", @"  |  |--<UIView:" ];
...
- (void)testHierarchyStringWithSubviews {
  ...
  NSString *stringHierarchy = [GREYElementHierarchy hierarchyStringForElement:viewA];
  NSArray *stringTargetHierarchy = @[ @"<UIView:", @"  |--<UIView:" ];
  [self grey_assertString:stringHierarchy containsStringsInArray:stringTargetHierarchy];
}
...
- (void)testHierarchyStringWithAccessibilityViews {
  ...
  NSString *stringHierarchy = [GREYElementHierarchy hierarchyStringForElement:viewA];
  NSArray *stringTargetHierarchy = @[ @"<GREYUTCustomAccessibilityView:", @"  |--<UIView:" ];
  [self grey_assertString:stringHierarchy containsStringsInArray:stringTargetHierarchy];
}
...
- (void)testStringForCascadingHierarchyWithBothSubviewsandAXViews {
  ...
  NSString *stringHierarchy = [GREYElementHierarchy hierarchyStringForElement:viewA];
  NSArray *stringTargetHierarchy = @[
    @"<GREYUTCustomAccessibilityView:", @"  |--<UIView:",
    @"  |  |--<GREYUTCustomAccessibilityView:", @"  |  |  |--<UIView:"
  ];
  [self grey_assertString:stringHierarchy containsStringsInArray:stringTargetHierarchy];
}
...
- (void)testPrintingOfDescriptionAtLevelZero {
  ...
  NSString *printSubstring = [GREYElementHierarchy grey_printDescriptionForElement:viewA atLevel:0];
...
- (void)testPrintingOfDescriptionAtLevelOne {
  UIView *viewA = [[UIView alloc] initWithFrame:kTestRect];
  NSString *targetString = @"  |--<UIView:";
  NSString *printSubstring = [GREYElementHierarchy grey_printDescriptionForElement:viewA atLevel:1];
  XCTAssert([[printSubstring substringToIndex:[targetString length]] isEqualToString:targetString]);
}
...
- (void)testPrintingOfDescriptionAtLevelTwo {
  UIView *viewA = [[UIView alloc] initWithFrame:kTestRect];
  NSString *targetString = @"  |  |--<UIView:";
  NSString *printSubstring = [GREYElementHierarchy grey_printDescriptionForElement:viewA atLevel:2];
  XCTAssert([[printSubstring substringToIndex:[targetString length]] isEqualToString:targetString]);
}
...
- (void)testAnnotationsForMultipleViews {
  ...
  NSDictionary *annotations = @{
    [NSValue valueWithNonretainedObject:viewA] : viewAAnnotation,
...
- (void)testHierarchyStringForSingleAccessibilityElement {
  ...
  NSString *targetString =
      [NSString stringWithFormat:@"<UIAccessibilityElement:%p; isAccessible=Y; AX.id='AxElement'; "
...
- (void)testHierarchyStringForViewWithAccessibilityElement {
  ...
  NSArray *stringTargetHierarchy =
      @[ @"<UIView:", @"  |--<GREYUTCustomAccessibilityView:", @"  |--<UIAccessibilityElement:" ];
  [self grey_assertString:stringHierarchy containsStringsInArray:stringTargetHierarchy];
}
...
- (void)testHierarchyStringForViewWithAccessibilityElementsAndSubviews {
  ...
  NSString *stringHierarchy = [GREYElementHierarchy hierarchyStringForElement:viewA];
  NSArray *stringTargetHierarchy = @[
    @"<UIView:", @"  |--<UIView:", @"  |--<GREYUTCustomAccessibilityView:",
...
- (void)testHierarchyStringForViewWithCascadingAXElements {
  ...
  NSString *stringHierarchy = [GREYElementHierarchy hierarchyStringForElement:viewA];
  NSArray *stringTargetHierarchy = @[
    @"<GREYUTCustomAccessibilityView:", @"<UIAccessibilityElement:",
    @"  |--<GREYUTCustomAccessibilityView:", @"  |--<UIAccessibilityElement:",
    @"  |  |--<GREYUTCustomAccessibilityView:", @"  |  |--<UIAccessibilityElement:"
  ];
  [self grey_assertString:stringHierarchy containsStringsInArray:stringTargetHierarchy];
...
- (void)testHierarchyStringForAXViewWithAnnotations {
  ...
  NSDictionary *annotations = @{[NSValue valueWithNonretainedObject:elementA] : elementAAnnotation};
  NSString *stringHierarchy = [GREYElementHierarchy hierarchyStringForElement:elementA
                                                     withAnnotationDictionary:annotations];
  NSString *targetString =
      [NSString stringWithFormat:@"<UIAccessibilityElement:%p; isAccessible=Y; "
                                 @"AX.frame={{0, 0}, {0, 0}}; AX.activationPoint={0, 0}; "
                                 @"AX.traits='UIAccessibilityTraitNone'; AX.focused='N'> "
                                 @"This is Accessibility Element A"
                                 @"\n\n**** No Animating Views Found. ****\n",
                                 elementA];
  XCTAssertEqualObjects(targetString, stringHierarchy);
}
...
- (void)testDumpUIHierarchyForWindow {
  ...
  NSString *uiViewCustomPrefix = [NSString stringWithFormat:@"<UIView:%p; isAccessible=N;", view];
  NSString *imgViewCustomPrefix =
      [NSString stringWithFormat:@"<UIImageView:%p; isAccessible=N;", imageView];
...
- (void)testHierarchyStringForNSObjectCategory {
  ...
  stringTargetHierarchy = @[ @"<GREYUTCustomAccessibilityView:", @"  |--<UIAccessibilityElement:" ];
...
- (void)testTraversalDoesNotVisitSameElementTwice {
  ...
  NSArray *stringTargetHierarchy = @[
    @"<GREYUTAccessibilityViewContainerView:", @"  |--<UIView:", @"",
    @"**** No Animating Views Found. ****", @""
  ];
  NSString *hierarchyForView = [view grey_recursiveDescription];
  // Remove whitespaces added by new lines added for the animation info.
  NSMutableArray *components = [[hierarchyForView componentsSeparatedByString:@"\n"] mutableCopy];
